...
__decorate([
    (0, typeorm_1.ManyToOne)(() => user_entity_1.User, (user) => user.checkIns, { onDelete: 'CASCADE' }),
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => event_entity_1.Event, (event) => event.checkIns, { onDelete: 'CASCADE' }),
...
], CheckIn.prototype, "latitude", void 0);
__decorate([
    (0, typeorm_1.Column)({ type: 'decimal', precision: 10, scale: 7 }),
    __metadata("design:type", Number)
], CheckIn.prototype, "longitude", void 0);
__decorate([
