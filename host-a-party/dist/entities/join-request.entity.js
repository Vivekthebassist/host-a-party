...
exports.JoinRequest = exports.JoinRequestStatus = void 0;
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => user_entity_1.User, (user) => user.joinRequests, { onDelete: 'CASCADE' }),
...
__decorate([
    (0, typeorm_1.Column)(),
    __metadata("design:type", String)
], JoinRequest.prototype, "userId", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => event_entity_1.Event, (event) => event.joinRequests, { onDelete: 'CASCADE' }),
    (0, typeorm_1.JoinColumn)({ name: 'eventId' }),
    __metadata("design:type", event_entity_1.Event)
], JoinRequest.prototype, "event", void 0);
__decorate([
    (0, typeorm_1.Column)(),
    __metadata("design:type", String)
], JoinRequest.prototype, "eventId", void 0);
__decorate([
    (0, typeorm_1.Column)({
        type: 'enum',
...
__decorate([
    ...
    __metadata("design:type", String)
], JoinRequest.prototype, "message", void 0);
__decorate([
    (0, typeorm_1.Column)({ nullable: true }),
    __metadata("design:type", String)
], JoinRequest.prototype, "respondedBy", void 0);
__decorate([
    (0, typeorm_1.Column)({ type: 'timestamp', nullable: true }),
    __metadata("design:type", Date)
], JoinRequest.prototype, "respondedAt", void 0);
__decorate([
...
exports.JoinRequest = JoinRequest = __decorate([
    (0, typeorm_1.Entity)('join_requests'),
    (0, typeorm_1.Unique)(['userId', 'eventId'])
], JoinRequest);
//# sourceMappingURL=join-request.entity.js.map