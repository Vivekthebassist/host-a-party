...
], Message.prototype, "match", void 0);
__decorate([
    (0, typeorm_1.Index)(),
    (0, typeorm_1.Column)(),
    __metadata("design:type", String)
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => user_entity_1.User, (user) => user.messagesSent, { onDelete: 'CASCADE' }),
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => event_entity_1.Event, (event) => event.messages, { onDelete: 'CASCADE' }),
...
__decorate([
    (0, typeorm_1.Column)({ type: 'enum', enum: ['text', 'image', 'emoji'], default: 'text' }),
    __metadata("design:type", String)
